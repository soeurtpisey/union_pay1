...
#import "WeCloudDatabase.h"
NS_ASSUME_NONNULL_BEGIN
/** Category of additions for `<WeCloudDatabase>` class.
...
@interface WeCloudDatabase (WeCloudDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `WeCloudResultSet` of schema; `nil` on error.
 
 @see [SQLite File Format](http://www.sqlite.org/fileformat.html)
 */

- (WeCloudResultSet *)getSchema;
...
- (WeCloudResultSet*)getTableSchema:(NSString*)tableName;
