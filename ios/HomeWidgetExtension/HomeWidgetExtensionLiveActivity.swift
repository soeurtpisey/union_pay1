...
struct HomeWidgetExtensionLiveActivity_Previews: PreviewProvider {
    static let attributes = HomeWidgetExtensionAttributes(name: "Me")
    static let contentState = HomeWidgetExtensionAttributes.ContentState(value: 3)
